...
func SubmitFile(service *services.Service, filename string, file io.Reader, force string) (*ScanResult, error) {
...
func Discan(service *services.Service, filename string, file io.Reader) (*ScanResult, error) {
