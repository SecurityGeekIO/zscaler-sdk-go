...
func SubmitFile(service *zidentity.Service, filename string, file io.Reader, force string) (*ScanResult, error) {
...
func Discan(service *zidentity.Service, filename string, file io.Reader) (*ScanResult, error) {
	return scanFile(service, filename, file, "", discanEndpoint)
}

func scanFile(service *zidentity.Service, filename string, file io.Reader, force, endpoint string) (*ScanResult, error) {
