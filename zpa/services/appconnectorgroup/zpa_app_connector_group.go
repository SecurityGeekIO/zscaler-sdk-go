...
func Create(service *services.Service, appConnectorGroup AppConnectorGroup) (*AppConnectorGroup, *http.Response, error) {
	v := new(AppConnectorGroup)
	resp, err := service.NewRequestDo("POST", mgmtConfig+service.Client.GetCustomerID()+appConnectorGroupEndpoint, common.Filter{MicroTenantID: service.MicroTenantID()}, appConnectorGroup, &v)
	if err != nil {
		return nil, nil, err
	}
...
func Update(service *services.Service, appConnectorGroupID string, appConnectorGroup *AppConnectorGroup) (*http.Response, error) {
	...
	resp, err := service.NewRequestDo("PUT", relativeURL, common.Filter{MicroTenantID: service.MicroTenantID()}, appConnectorGroup, nil)
	if err != nil {
		return nil, err
	}
