...
func getAllPagesGenericWithCustomFilters[T any](client common.Client, relativeURL string, page, pageSize int, filters Filter) (int, []T, *http.Response, error) {
	var v struct {
	...
	}, nil, &v, common.Option{Name: common.ZscalerInfraOption, Value: "zpa"})
	if err != nil {
...
func getAllPagesGeneric[T any](client common.Client, relativeURL string, page, pageSize int, filters Filter) (int, []T, *http.Response, error) {
...
func GetAllPagesGeneric[T any](client common.Client, relativeURL, searchQuery string) ([]T, *http.Response, error) {
...
func getMicroTenantByName(client common.Client, microTenantName string) (*microTenantSample, *http.Response, error) {
...
func GetAllPagesGenericWithCustomFilters[T any](client common.Client, relativeURL string, filters Filter) ([]T, *http.Response, error) {
