...
* [PR #350](https://github.com/SecurityGeekIO/zscaler-sdk-python/pull/350) - Enhanced `CheckErrorInResponse` function to parse and display API error messages more clearly.
