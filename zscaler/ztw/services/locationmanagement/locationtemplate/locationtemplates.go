...
const (
	locationTemplateEndpoint = "/ztw/api/v1/locationTemplate"
)
...
func Get(ctx context.Context, service *zscaler.Service, locTemplateID int) (*LocationTemplate, error) {
	...
	err := service.Client.ReadResource(ctx, fmt.Sprintf("%s/%d", locationTemplateEndpoint, locTemplateID), &location)
	if err != nil {
		return nil, err
	}
...
func GetByName(ctx context.Context, service *zscaler.Service, templateName string) (*LocationTemplate, error) {
...
func Create(ctx context.Context, service *zscaler.Service, locations *LocationTemplate) (*LocationTemplate, error) {
	resp, err := service.Client.CreateResource(ctx, locationTemplateEndpoint, *locations)
	if err != nil {
		return nil, err
	}
...
func Update(ctx context.Context, service *zscaler.Service, locTemplateID int, locations *LocationTemplate) (*LocationTemplate, *http.Response, error) {
	resp, err := service.Client.UpdateWithPutResource(ctx, fmt.Sprintf("%s/%d", locationTemplateEndpoint, locTemplateID), *locations)
	if err != nil {
		return nil, nil, err
	}
...
func Delete(ctx context.Context, service *zscaler.Service, locTemplateID int) (*http.Response, error) {
	err := service.Client.DeleteResource(ctx, fmt.Sprintf("%s/%d", locationTemplateEndpoint, locTemplateID))
	if err != nil {
		return nil, err
	}
...
func GetAll(ctx context.Context, service *zscaler.Service) ([]LocationTemplate, error) {
