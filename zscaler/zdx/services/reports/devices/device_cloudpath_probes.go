...
func GetAllCloudPathProbes(ctx context.Context, service *zscaler.Service, deviceID, appID int, filters common.GetFromToFilters) ([]DeviceCloudPathProbe, *http.Response, error) {
...
func GetDeviceAppCloudPathProbe(ctx context.Context, service *zscaler.Service, deviceID, appID, probeID int, filters common.GetFromToFilters) ([]NetworkStats, *http.Response, error) {
	var v []NetworkStats
...
func GetCloudPathAppDevice(ctx context.Context, service *zscaler.Service, deviceID, appID, probeID int, filters common.GetFromToFilters) ([]CloudPathProbe, *http.Response, error) {
