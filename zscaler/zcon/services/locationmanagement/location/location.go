...
import (
	...
	"github.com/SecurityGeekIO/zscaler-sdk-go/v2/zscaler/zcon/services/common"
)

const (
	locationsEndpoint = "/location"
)
...
type Locations struct {
	...
	// Not applicable to Cloud & Branch Connector.
	VirtualZens []common.GeneralPurpose `json:"virtualZens,omitempty"`

	// Not applicable to Cloud & Branch Connector.
	VirtualZenClusters []common.GeneralPurpose `json:"virtualZenClusters,omitempty"`

	// Not applicable to Cloud & Branch Connector.
	StaticLocationGroups []common.GeneralPurpose `json:"staticLocationGroups,omitempty"`

	// Not applicable to Cloud & Branch Connector.
	DynamiclocationGroups []common.GeneralPurpose `json:"dynamiclocationGroups,omitempty"`

	// AWS/Azure subcription ID associated with this location.
	PublicCloudAccountId []common.GeneralPurpose `json:"publicCloudAccountId,omitempty"`
