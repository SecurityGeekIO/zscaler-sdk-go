...
import (
	...
	"github.com/SecurityGeekIO/zscaler-sdk-go/v3/zscaler/zpa/services/serviceedgecontroller"
...
type ServiceEdgeGroup struct {
	...
	ExclusiveForBusinessContinuity bool                                          `json:"exclusiveForBusinessContinuity,omitempty"`
