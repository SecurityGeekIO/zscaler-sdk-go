...
func TestDNSGateways(t *testing.T) {
	...
	var createdResource *DNSGateways

	// Test resource creation
	err = retryOnConflict(func() error {
		createdResource, _, err = Create(context.Background(), service, &gw)
		return err
	})
	if err != nil {
...
func tryRetrieveResource(s *zscaler.Service, id int) (*DNSGateways, error) {
	var resource *DNSGateways
	var err error
...
func TestUpdateNonExistentResource(t *testing.T) {
	...
	_, _, err = Update(context.Background(), service, 0, &DNSGateways{})
	if err == nil {
