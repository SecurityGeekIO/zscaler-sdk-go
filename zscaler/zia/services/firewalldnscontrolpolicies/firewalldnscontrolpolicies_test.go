...
func TestFirewallIPSRule(t *testing.T) {
	...
	var createdResource *FirewallDNSRules
...
func tryRetrieveResource(s *zscaler.Service, id int) (*FirewallDNSRules, error) {
	var resource *FirewallDNSRules
	var err error
...
func TestUpdateNonExistentResource(t *testing.T) {
	...
	_, err = Update(context.Background(), service, 0, &FirewallDNSRules{})
	if err == nil {
