...
func SubmitFile(ctx context.Context, service *zscaler.Service, filename string, file io.Reader, force string) (*ScanResult, error) {
	return scanFile(ctx, service, filename, file, force, submitEndpoint)
}
...
func Discan(ctx context.Context, service *zscaler.Service, filename string, file io.Reader) (*ScanResult, error) {
	return scanFile(ctx, service, filename, file, "", discanEndpoint)
}

func scanFile(ctx context.Context, service *zscaler.Service, filename string, file io.Reader, force, endpoint string) (*ScanResult, error) {
