...
const (
	cloudApplicationsEndpoint    = "/zia/api/v1/cloudApplications/lite"
	customTagsEndpoint           = "/zia/api/v1/customTags"
	appExportEndpoint            = "/zia/api/v1/shadowIT/applications/export"
	appExportCsvEndpointTemplate = "/zia/api/v1/shadowIT/applications/%s/exportCsv"
	appBulkUpdateEndpoint        = "/zia/api/v1/cloudApplications/bulkUpdate"
)
...
func GetAllCloudAppsLite(ctx context.Context, service *zscaler.Service, pageNumber, limit *int) ([]CloudApplicationsAndCustomTags, error) {
	...
	err := service.Client.Read(ctx, endpoint, &cloudAppsLite)
	if err != nil {
		return nil, err
	}
...
func GetAllCustomTags(ctx context.Context, service *zscaler.Service) ([]CloudApplicationsAndCustomTags, error) {
	...
	err := service.Client.Read(ctx, customTagsEndpoint, &customTags)
...
func CreateCloudApplicationsExport(ctx context.Context, service *zscaler.Service, exportRequest CloudApplicationsExport) (*http.Response, error) {
	...
	resp, err := service.Client.Create(ctx, appExportEndpoint, exportRequest)
	if err != nil {
		return nil, err
	}
...
func Update(ctx context.Context, service *zscaler.Service, rules *ApplicationBulkUpdate) (*ApplicationBulkUpdate, error) {
	resp, err := service.Client.UpdateWithPut(ctx, appBulkUpdateEndpoint, *rules)
	if err != nil {
		return nil, err
	}
