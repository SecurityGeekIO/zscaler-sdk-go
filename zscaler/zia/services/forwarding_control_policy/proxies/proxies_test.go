...
func TestProxies(t *testing.T) {
	...
	var createdResource *Proxies

	// Test resource creation
	err = retryOnConflict(func() error {
		createdResource, _, err = Create(context.Background(), service, &proxy)
		return err
	})
	if err != nil {
...
func tryRetrieveResource(s *zscaler.Service, id int) (*Proxies, error) {
	var resource *Proxies
	var err error
...
func TestUpdateNonExistentResource(t *testing.T) {
	...
	_, _, err = Update(context.Background(), service, 0, &Proxies{})
	if err == nil {
