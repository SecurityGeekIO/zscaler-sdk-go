...
func GetAdminUsers(service *zscaler.Service, adminUserId int) (*AdminUsers, error) {
	v := new(AdminUsers)
...
func GetAdminUsersByLoginName(service *zscaler.Service, adminUsersLoginName string) (*AdminUsers, error) {
...
func GetAdminByUsername(service *zscaler.Service, adminUsername string) (*AdminUsers, error) {
	adminUsers, err := GetAllAdminUsers(service)
	if err != nil {
		return nil, err
	}
...
func CreateAdminUser(service *zscaler.Service, adminUser AdminUsers) (*AdminUsers, error) {
...
func UpdateAdminUser(service *zscaler.Service, adminUserID int, adminUser AdminUsers) (*AdminUsers, error) {
...
func DeleteAdminUser(service *zscaler.Service, adminUserID int) (*http.Response, error) {
...
func GetAllAdminUsers(service *zscaler.Service) ([]AdminUsers, error) {
