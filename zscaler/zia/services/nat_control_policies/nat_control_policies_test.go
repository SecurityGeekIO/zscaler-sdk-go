...
func TestNATControlRule(t *testing.T) {
	...
	var createdResource *NatControlPolicies
...
func tryRetrieveResource(s *zscaler.Service, id int) (*NatControlPolicies, error) {
	var resource *NatControlPolicies
	var err error
...
func TestUpdateNonExistentResource(t *testing.T) {
	...
	_, err = Update(context.Background(), service, 0, &NatControlPolicies{})
	if err == nil {
