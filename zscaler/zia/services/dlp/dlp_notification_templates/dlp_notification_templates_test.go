...
func TestDlpNotificationTemplates(t *testing.T) {
	...
	err = retryOnConflict(func() error {
		createdResource, _, err = Create(context.Background(), service, &dlpTemplate)
		return err
	})
	if err != nil {
...
func tryRetrieveResource(s *zscaler.Service, id int) (*DlpNotificationTemplates, error) {
...
func TestUpdateNonExistentResource(t *testing.T) {
	...
	_, _, err = Update(context.Background(), service, 0, &DlpNotificationTemplates{})
	if err == nil {
